...
const uploadService = {
  ...
  uploadProfilePicture: async (file) => {
    ...
    await profileService.updateMyProfile({ base_profile: { profile_picture_public_id: public_id } })
    return public_id
  },
  ...
  uploadDocument: async (file, { document_type, title, description }) => {
    ...
    await profileService.uploadDocument({ document_type, title, description, public_id, resource_type })
