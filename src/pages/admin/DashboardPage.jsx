...
const DEMO_DATA = {
  ...
  departmentDistribution: [
    { name: 'Computer Science', students: 620 },
    { name: 'Engineering', students: 480 },
    { name: 'Business', students: 410 },
    { name: 'Humanities', students: 320 },
    { name: 'Mathematics', students: 280 },
    { name: 'Physics', students: 200 },
    { name: 'Biology', students: 173 },
  ],
  recentActivity: [
