  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-xl mt-10 border border-gray-100">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-6">
        ...
        <div>
          <label className="block text-sm font-semibold text-gray-700 mb-1">Required Credit Hours</label>
          <input 
            type="number" 
            className="w-full border border-gray-300 p-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" 
            value={formData.total_credit_hours_required}
            onChange={(e) => setFormData({...formData, total_credit_hours_required: e.target.value})} 
            required 
          />
        </div>
