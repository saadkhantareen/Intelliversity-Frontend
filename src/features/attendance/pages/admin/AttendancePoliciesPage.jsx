...
const FIELDS = {
  ...
  leaveCountsAsPresent: "leave_counts_as_present",
  isActive: "is_active",
  term: "term",
};
...
function toPayload(form) {
  const payload = {
    ...
    [FIELDS.leaveCountsAsPresent]: Boolean(form.countLeaveAsPresent),
  };
...
function toForm(p) {
  return {
    ...
    countLeaveAsPresent: Boolean(
      pick(p, ["leave_counts_as_present", "count_leave_as_present", "leave_counts_present"], true)
    ),
