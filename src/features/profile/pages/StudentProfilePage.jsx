...
const StudentProfilePage = () => {
  ...
  const { base_profile, roll_number, program, current_semester, cgpa, batch, section_name } =
    profileData;
        ...
        <div className="text-center sm:text-left mt-2 flex-1">
          ...
          <div className="flex flex-wrap justify-center sm:justify-start gap-3 text-sm text-gray-600 mb-3">
            <span className="bg-gray-100 px-3 py-1 rounded-full border border-gray-200">
              <strong className="text-gray-900">Roll No:</strong> {roll_number || 'N/A'}
            </span>
            <span className="bg-gray-100 px-3 py-1 rounded-full border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={label}>
              ...
              <p className="text-base text-gray-900 font-medium">{value || 'N/A'}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 mb-6 shadow-sm border border-gray-100">
        ...
        >
          <div className="flex flex-col items-center mb-4">
            ...
            <p className="text-blue-700 font-semibold text-lg">Upload a Document</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              {isUploading ? 'Uploading to secure storage...' : 'Upload Document'}
            </button>
          </div>
        </form>
          ...
          {documents.length > 0 ? (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
              <p className="text-gray-500 font-medium">
                No documents found. Upload your certificates or transcripts above.
              </p>
            </div>
          )}
        </div>
